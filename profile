...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="VISHWARAJ P" alt="your profile picture" class="profile=picture">
               <h1>Vishwaraj</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone! This is VISHWARAJ P and i am a computer science learner.</p>
                </div>
            </section>
